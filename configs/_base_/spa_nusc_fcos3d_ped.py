_base_ = [
    '../_base_/datasets/spa_nus-mono3d.py', '../_base_/models/fcos3d.py',
]
# ====================== dataset pipeline ==============================
...
work_dir = None
# load_from = None
load_from = '/home/changwon/detection_task/mmdetection3d/pretrain/fcos3d_r101_caffe_fpn_gn-head_dcn_2x8_1x_nus-mono3d_20210715_235813-4bed5239.pth'
resume_from = None
workflow = [('train', 1)]
