_base_ = [
    '../_base_/datasets/spa_mvx-3d.py',
    '../_base_/models/centerpoint_02pillar_second_secfpn_mvx.py',
...
load_from =None
resume_from = "/home/changwon/detection_task/mmdetection3d/work_dirs/spa_mvx_centerpoint/latest.pth"
