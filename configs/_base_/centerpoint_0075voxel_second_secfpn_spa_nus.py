...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_cls=dict(type='GaussianFocalLoss', reduction='mean'),
        # loss_bbox=dict(type='L1Loss', reduction='mean', loss_weight=0.25),
        loss_bbox=dict(type='SmoothL1Loss', reduction='mean', loss_weight=0.25),
        norm_bbox=True),
...
# load_from = "/home/changwon/detection_task/mmdetection3d/work_dirs/centerpoint_0075voxel_second_secfpn_spa_nus/epoch_20.pth"
load_from = None